...
- 🖨️ **Affichage à 1200 bauds** : à chaque page, **tous les textes** se peignent
  caractère par caractère en balayage raster — ligne par ligne, du haut vers le bas
  de la page, curseur de balayage compris — comme sur un vrai Minitel qui reçoit sa
  page (~1500 caractères/s, entre 4 et 9 s par page). Sans saut de mise en page
  (les caractères non révélés sont masqués par des insécables, même largeur en
  monospace).
